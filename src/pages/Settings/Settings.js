...
{/* 🔑 Dynamic Login / Premium Button */}<div className="user-card"  onClick={() => goToPage("/premium") }>
  ...
  style={{
    ...
    boxShadow: user?.username

      ? user?.premium

        ? "0 0 15px 5px #00f" // premium → blue glow

        : "0 0 15px 5px #0f0" // username exists → green glow

      : "0 0 15px 5px #f00",  // no user → red glow

    borderRadius: "50%" // optional circular glow
